...
![Схема взаимодействия сервисов - регистрация](.img/Регистрация.png)

![Схема взаимодействия сервисов - аутентификация](.img/Аутентификация.png)

![Схема взаимодействия сервисов - изменение профиля](.img/Изменение_профиля.png)
